...
class IndividualScore(models.Model):
    ...
    home_player = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='home_scores', null=True, blank=True)
    away_player = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='away_scores', null=True, blank=True)
